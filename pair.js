...
router.get('/', async (req, res) => {
    ...
    async function SPIDEY_MD_PAIR_CODE() {
        const { state, saveCreds } = await useMultiFileAuthState('./temp/' + id);
        try {
            let Pair_Code_By_ALPHA_KING = ALPHA KING({
                auth: {
                    creds: state.creds,
            ...
            Pair_Code_By_Mbuvi_Tech.ev.on('connection.update', async (s) => {
                ...
                if (connection === 'open') {
                    ...
                    let session = await Pair_Code_By_Mbuvi_Tech.sendMessage(Pair_Code_By_Mbuvi_Tech.user.id, { text: 'SPIDEY~' + b64data });
